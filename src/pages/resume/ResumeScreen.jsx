...
function ResumeScreen() {    
    ...
    return (
        <div className='h-screen flex flex-col'>
            <ResumeItems/>
            <div className={`min-h-[80px] bg-blue-100  w-full flex items-center justify-center`}>
...
function ResumeItems() {
    return (
        <div style={{ backgroundImage: `url(${bgImage})` }} className='grow bg-cover bg-center '>
            <VerticalTimeline>
                ...
                >
                    ...
                    <p>
                        Mobile App Developer, Frontend Developer, Backend Developer, IT & Program Analyst, Core Banking QA Tester
                    </p>
                </VerticalTimelineElement>
                <VerticalTimelineElement
                    className="vertical-timeline-element--work"
                ...
                >
                    ...
                    <p>
                        Software Engineering Division (SEIS) - Departement Of Computer Science 
                    </p>
                </VerticalTimelineElement>
